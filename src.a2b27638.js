...
var author$project$Main$ChangingSettings = function (a) {
	return {$: 'ChangingSettings', a: a};
};
var author$project$Main$SplittingAmount = F2(
	function (a, b) {
		return {$: 'SplittingAmount', a: a, b: b};
	});
var author$project$Main$initPerson = {contribution: 0, name: ''};
var author$project$Money$GBP = {$: 'GBP'};
var author$project$Money$Money = F2(
	function (a, b) {
		return {$: 'Money', a: a, b: b};
	});
var author$project$Money$zero = A2(author$project$Money$Money, author$project$Money$GBP, 0);
var author$project$Settings$Settings = F2(
	function (personOne, personTwo) {
		return {personOne: personOne, personTwo: personTwo};
	});
var author$project$Settings$Person = F2(
	function (name, contribution) {
		return {contribution: contribution, name: name};
	});
...
var author$project$Settings$personDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Settings$Person,
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'contribution', elm$json$Json$Decode$int));
var author$project$Settings$decoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Settings$Settings,
	A2(elm$json$Json$Decode$field, 'personOne', author$project$Settings$personDecoder),
	A2(elm$json$Json$Decode$field, 'personTwo', author$project$Settings$personDecoder));
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var elm$json$Json$Decode$decodeValue = _Json_run;
var author$project$Main$init = function (flags) {
	var model = function () {
		var _n0 = A2(elm$json$Json$Decode$decodeValue, author$project$Settings$decoder, flags);
		if (_n0.$ === 'Err') {
			return author$project$Main$ChangingSettings(
				{personOne: author$project$Main$initPerson, personTwo: author$project$Main$initPerson});
		} else {
			var settings = _n0.a;
			return A2(author$project$Main$SplittingAmount, settings, author$project$Money$zero);
		}
	}();
...
var author$project$Main$updatePerson = F3(
	function (field, value, form) {
		if (field.$ === 'Name') {
			...
			if (_n1.$ === 'Just') {
				var contribution = _n1.a;
				return _Utils_update(
					form,
					{contribution: contribution});
			} else {
				return (!elm$core$String$length(value)) ? _Utils_update(
					form,
					{contribution: 0}) : form;
			}
		}
...
var author$project$Settings$settingsUpdated = _Platform_outgoingPort(
	'settingsUpdated',
	function ($) {
						...
						return elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'contribution',
									elm$json$Json$Encode$int($.contribution)),
									_Utils_Tuple2(
									'name',
...
var author$project$Main$updateSettings = F2(
	function (msg, settings) {
		switch (msg.$) {
			case 'UpdateSettings':
				var personOrder = msg.a;
				var field = msg.b;
				var value = msg.c;
				var newSetting = function () {
					if (personOrder.$ === 'First') {
						return _Utils_update(
							settings,
							{
								personOne: A3(author$project$Main$updatePerson, field, value, settings.personOne)
							});
					} else {
						return _Utils_update(
							settings,
							{
								personTwo: A3(author$project$Main$updatePerson, field, value, settings.personTwo)
							});
					}
				}();
				return _Utils_Tuple2(
					author$project$Main$ChangingSettings(newSetting),
					elm$core$Platform$Cmd$none);
			case 'SaveSettings':
				return _Utils_Tuple2(
					A2(author$project$Main$SplittingAmount, settings, author$project$Money$zero),
					author$project$Settings$settingsUpdated(settings));
			default:
				return _Utils_Tuple2(
					author$project$Main$ChangingSettings(settings),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Money$addDigit = F2(
	function (digit, _n0) {
		var currency = _n0.a;
		var amount = _n0.b;
...
var author$project$Main$update = F2(
	function (msg, state) {
		if (state.$ === 'SplittingAmount') {
			...
			var settings = state.a;
			return A2(author$project$Main$updateSettings, msg, settings);
		}
	});
...
var author$project$Main$body = function (inner) {
	return A3(
...
var author$project$Main$headerBackgroundColor = A3(mdgriffith$elm_ui$Element$rgb255, 120, 144, 156);
var author$project$Main$headerColor = A3(mdgriffith$elm_ui$Element$rgb255, 240, 240, 240);
...
var author$project$Main$header = A2(
	...
	_List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
			A2(mdgriffith$elm_ui$Element$Font$glow, author$project$Main$black, 4),
...
var author$project$Main$rowStyles = elm$core$List$append(
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
...
var author$project$Main$inputView = function () {
	...
	var makeButton = F2(
		function (label, msg) {
			return A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Events$onMouseDown(msg),
						mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
	...
	var makeDigitButton = function (digit) {
		return A2(
			makeButton,
			elm$core$String$fromInt(digit),
			author$project$Main$AddDigit(digit));
	};
	var makeDigitRow = function (digits) {
		return makeRow(
			A2(elm$core$List$map, makeDigitButton, digits));
	};
	return A2(
		mdgriffith$elm_ui$Element$el,
...
var author$project$Money$toString = function (_n0) {
	var currency = _n0.a;
	var amount = _n0.b;
	var amountAsFloat = amount;
	var integer = elm$core$Basics$floor(amountAsFloat / 100);
	var fractional = elm$core$Basics$round(((amountAsFloat / 100) - integer) * 100);
...
var author$project$Main$totalView = function (money) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		author$project$Main$rowStyles(
			_List_fromArray(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$text(
					author$project$Money$toString(money)))
			]));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					author$project$Main$totalView(money),
					A2(author$project$Main$splitView, settings, money),
					author$project$Main$inputView
				]));
	});
var author$project$Main$First = {$: 'First'};
var author$project$Main$SaveSettings = {$: 'SaveSettings'};
var author$project$Main$Second = {$: 'Second'};
var author$project$Main$Contribution = {$: 'Contribution'};
var author$project$Main$Name = {$: 'Name'};
var author$project$Main$UpdateSettings = F3(
	function (a, b, c) {
		return {$: 'UpdateSettings', a: a, b: b, c: c};
	});
...
var author$project$Main$personSettingsView = F2(
	function (personNumber, form) {
		var number = function () {
				...
				_List_fromArray(
					[
						...
						_List_Nil,
						{
							...
							onChange: A2(author$project$Main$UpdateSettings, personNumber, opts.field),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$text('PersonOrder ' + number)),
					inputRow(
					{field: author$project$Main$Name, label: 'Name', value: form.name}),
					inputRow(
					{
						field: author$project$Main$Contribution,
						label: 'Contribution',
						value: elm$core$String$fromInt(form.contribution)
					})
				]));
	});
...
var author$project$Main$settingsView = function (settings) {
	var saveButton = A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_Nil,
				{
					...
					onPress: elm$core$Maybe$Just(author$project$Main$SaveSettings)
				})
			]));
	return A2(
		mdgriffith$elm_ui$Element$column,
		...
		_List_fromArray(
			[
				...
				A2(author$project$Main$personSettingsView, author$project$Main$First, settings.personOne),
				A2(author$project$Main$personSettingsView, author$project$Main$Second, settings.personTwo),
				saveButton
			]));
};
var author$project$Main$view = function (state) {
	var innerView = function () {
		if (state.$ === 'ChangingSettings') {
			var settings = state.a;
			return author$project$Main$settingsView(settings);
		} else {
			var settings = state.a;
			var money = state.b;
			return A2(author$project$Main$mainView, settings, money);
		}
	}();
	return {
		body: _List_fromArray(
			[
				author$project$Main$body(innerView)
			]),
		title: 'Split'
	};
};
...
var persistedSettings = storage.getItem('settings');
var settings = null;
...
app.ports.settingsUpdated.subscribe(function (settings) {
  var persistedSettings = JSON.stringify(Object.assign({
    version: "v1"
  }, settings));
